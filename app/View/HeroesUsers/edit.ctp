...
<?php echo $this->Form->create('HeroesUser'); ?>
	<fieldset>
		<legend><?php echo __('Edit Heroes User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HeroesUser.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('HeroesUser.id'))); ?></li>
